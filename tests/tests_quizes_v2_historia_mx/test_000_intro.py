...
class TestQuizIntro(BaseTest):
    def test_intro(self):
        audio_path1 = edgetts_generar_voz("¡Solo un Mexicano Experto pasa este Test de Historia!",
    ...
    def test_ultima_pregunta(self):
        audio_path1 = edgetts_generar_voz("Última palabra y solo para expertos. ",
